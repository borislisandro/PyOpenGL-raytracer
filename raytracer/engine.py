...
class Engine:
    ...
    def createMegaTexture(self):
        ...
        filenames = [
            "Wood049_1K-PNG","Metal012_1K-PNG","Marble012_1K-PNG","Carpet012"
        ]
    ...
    def changeScenePositions(self,scene,number,pos,light_strength,light_radius):
        scene.changeObj(number,pos,light_strength,light_radius)
